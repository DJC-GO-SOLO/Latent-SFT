    ...
    def _gen_per_process(
        ...
        with torch.no_grad():
            while True:
                ...
                input_embeddings = model.decoder.model.model.embed_tokens(text_input['input_ids']) #bs:seq
...
if __name__ == '__main__':
    ...
    parser.add_argument('--check_point', default='376', type=str)
    parser.add_argument('--encoder_name_or_path', default='../output/stage1encoderresults/llama3.2-1b-stage1-encoder/best_hf', type=str)
    parser.add_argument('--decoder_name_or_path', default='../output/stage1decoderresults/llama3.2-1b-stage1-decoder/best_hf', type=str)
    parser.add_argument('--lora_path', default='../output/stage1unionresults/llama3.2-1b-stage1-union', type=str)
    parser.add_argument('--save_path', default='../output/stage1unionresults/llama3.2-1b-stage1-union/eval', type=str)
    ...
    good_results_items = []
    ## evaluate
    for index,i in enumerate(range(len(data))):
    ...
    write_jsonl(data,os.path.join(args.save_path,f'_{args.max_new_tokens}_{args.dataset}_result.jsonl'))
