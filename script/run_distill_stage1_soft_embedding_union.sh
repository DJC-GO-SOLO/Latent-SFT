...
save_root="../output/stage1unionresults"
output_name="llama3.2-1b-stage1-union"
...
decoder_name_or_path="../output/stage1decoderresults/llama3.2-1b-stage1-decoder/best_hf" # Path to best-performing model
description=""
...
torchrun \
    $distributed_args \
    run_distill_stage1_soft_embedding_union.py \
    $model_args \
    $data_args \
    $stage1_train_args \
    $train_args
